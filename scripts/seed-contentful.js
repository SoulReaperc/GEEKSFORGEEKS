...
if (!MANAGEMENT_TOKEN || !SPACE_ID) {
	console.error(
		"Error: Please set CONTENTFUL_MANAGEMENT_TOKEN and CONTENTFUL_SPACE_ID environment variables.",
	);
	console.error(
		"You can find your Space ID in Contentful Settings -> General Settings.",
	);
	console.error(
		"You can generate a Management Token in Contentful Settings -> API Keys -> Content Management Tokens.",
	);
	process.exit(1);
}
