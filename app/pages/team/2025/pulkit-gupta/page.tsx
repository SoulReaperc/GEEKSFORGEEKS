...
export default function PulkitGuptaProfile() {
	const [profileData, setProfileData] = useState({
		...
		github: "#",
		about:
			"Hi, I’m Pulkit Gupta — driven by a passion for creating impactful digital solutions. From hackathons to leadership roles, I thrive on transforming ambitious ideas into reality. I excel in collaborative team environments and strive to leave a meaningful mark in the tech space.",
