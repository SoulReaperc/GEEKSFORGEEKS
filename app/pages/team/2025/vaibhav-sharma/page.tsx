...
export default function VaibhavSharmaProfile() {
	const [profileData, setProfileData] = useState({
		...
		github: "#",
		about:
			"I’m a third-year B.Tech Computer Science student at SRM Institute of Science and Technology (SRM-IST), passionate about building full stack web applications that deliver seamless, responsive user experiences. Tech Stack: As a Full Stack Developer skilled in the MERN stack (MongoDB, Express.js, React.js, Node.js), I build modern, scalable web apps with a focus on performance and usability. Problem Solving: I enjoy solving complex problems through Data Structures and Algorithms (DSA), enabling me to write efficient, optimized, and clean code across the stack. Campus Engagement: As the Event and Operations Head of the Geeks for Geeks Club, I lead the planning and execution of hackathons, coding contests, and tech events that foster collaboration and creativity. Future Goals: I aim to specialize in Full Stack Development, deepening my expertise in scalable architecture, cloud deployment, and cutting-edge web technologies to build impactful, real-world solutions.",
