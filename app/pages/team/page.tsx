...
export default function TeamPage() {
	...
	useEffect(() => {
		const fetchYears = async () => {
			try {
				...
				console.log(
					"TeamPage: Years Fetch Response items:",
	...
	useEffect(() => {
		...
		const fetchMembers = async () => {
			...
			try {
				...
				console.log(
					`Fetched ${response.items.length} members for year ${selectedYear}`,
				);
	...
	const memberPhotoMap = {
		...
		"Priya Patel":
			"/Users/sahilrajdubey/.gemini/antigravity/brain/cd18f689-c26a-4455-9649-16cdb8fce8d0/team_member_2_1765724513504.png",
		"Rahul Kumar":
			"/Users/sahilrajdubey/.gemini/antigravity/brain/cd18f689-c26a-4455-9649-16cdb8fce8d0/team_member_3_1765724531360.png",
		"Sneha Gupta":
			"/Users/sahilrajdubey/.gemini/antigravity/brain/cd18f689-c26a-4455-9649-16cdb8fce8d0/team_member_4_1765724547957.png",
		"Vikram Singh":
			"/Users/sahilrajdubey/.gemini/antigravity/brain/cd18f689-c26a-4455-9649-16cdb8fce8d0/team_member_5_1765724575419.png",
	};
	...
	const getTooltipItems = (memberList: string[]) => {
		return memberList.map((name, index) => ({
			...
			image:
				memberPhotoMap[name] ||
				`https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=46b94e&color=fff&size=100`,
		}));
	};
						...
						>
							...
							{facultyCoordinators.length > 0 && (
								<div>
									...
									>
										FACULTY{" "}
										<span style={{ color: "#46b94e" }}>COORDINATOR</span>
									</h2>
									<div
										style={{
											display: "flex",
							...
							>
								{availableYears.map((year) => (
									<button
										...
										style={{
											background:
												selectedYear === year ? "#46b94e" : "transparent",
											color: "white",
											border: "none",
											padding: "10px 24px",
											borderRadius: "40px",
															...
															<div className="px-8 pb-8 pt-4 border-t border-white/10">
																<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
																	{team.memberList.map((memberName, i) => {
																		const memberImage =
																			memberPhotoMap[memberName] ||
																			`https://ui-avatars.com/api/?name=${encodeURIComponent(memberName)}&background=1f1f1f&color=fff&size=100`;
										...
										<div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
											<div>
												<div className="text-4xl font-bold text-white mb-2">
													{teamsWithMembers.reduce(
														(acc, team) => acc + team.memberList.length,
														0,
													)}
												</div>
...
clickable?: boolean;
	...
	const imageSrc =
		member.image ||
		"https://placehold.co/300x300/111/46b94e?text=" + member.name[0];
