		...
		>
			...
			<div style={{ position: "relative", zIndex: 1 }}>
						...
						>
							<div
								style={{
									...
									height: "1px",
									background:
										"linear-gradient(90deg, transparent, rgba(70, 185, 78, 0.5), transparent)",
								}}
							/>
							...
							>
								...
								ideas? If yes, then you are on the right page. Achieve your
								dreams with GeeksforGeeks and upgrade your skillsets
								consistently to become more confident.
								<br />
								<br />
								GeeksforGeeks Campus Body at SRM NCR is working on the idea to
								impart knowledge among the geeks in a fun and exciting way. It
								will be achieved through events, hackathons and webinars to
								enlighten the mates.
								<br />
								<br />
								We aim for the perfection and success of all who are connected
								with us through this chapter. So keep yourself connected with us
								to ace your career beyond the skies.
								<br />
								<br />
								Wishing you luck!!
							</p>
						...
						>
							{[
								...
								},
								{
									...
									description:
										"Expert-led sessions featuring industry leaders sharing insights on cutting-edge technologies.",
								},
								{
									icon: Zap,
									title: "Innovation Labs",
									description:
										"Practical project-based learning experiences tackling real-world challenges.",
								},
								{
									icon: Award,
									title: "Skill Certification",
									description:
										"Recognized certifications validating your achievements and expertise.",
								},
							].map((item, index) => (
				...
				>
					<div style={{ maxWidth: "1000px", margin: "0 auto" }}>
						...
						>
							...
							>
								Frequently Asked{" "}
								<span style={{ color: "#46b94e" }}>Questions</span>
							</h2>
				...
				<div className="absolute bottom-[10px] w-full text-center z-20 text-white/60 text-xs px-4">
					<p>
						&#9426; Copyrights 2026 by GFG SRMIST DELHI NCR. All Rights
						Reserved.
					</p>
				</div>
			</div>
		...
		>
			...
			<div
				style={{
					...
					height: "2px",
					background:
						"linear-gradient(90deg, transparent, #46b94e, transparent)",
				}}
			/>
		</motion.div>
	);
		...
		>
			...
			>
				...
				>
					<Plus
						size={20}
						color={isOpen ? "#46b94e" : "rgba(255, 255, 255, 0.6)"}
					/>
				</motion.div>
			</button>
