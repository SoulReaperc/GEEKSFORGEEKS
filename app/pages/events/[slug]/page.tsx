		...
		<div className="min-h-screen bg-black text-white relative overflow-hidden">
			...
			<div className="relative z-10 pt-16 md:pt-24 pb-8 md:pb-12">
				<div className="max-w-6xl mx-auto px-4 md:px-6">
					<Link
						href="/pages/events"
						className="inline-flex items-center gap-1.5 md:gap-2 text-gray-400 hover:text-[#46b94e] mb-6 md:mb-8 transition-colors group text-sm md:text-base"
					>
						<ArrowLeft
							size={16}
							...
							<div className="absolute bottom-0 left-0 p-4 md:p-8 lg:p-12 w-full">
								...
								<div className="flex flex-wrap gap-2 md:gap-4 text-sm md:text-base lg:text-lg text-gray-200">
									<div className="flex items-center gap-1.5 md:gap-2 bg-white/10 px-3 py-1.5 md:px-5 md:py-2.5 rounded-full backdrop-blur-md border border-white/10 hover:bg-white/20 transition-colors">
										<Calendar
											size={14}
											className="md:w-[18px] md:h-[18px] text-[#46b94e]"
										/>
									...
									<div className="flex items-center gap-1.5 md:gap-2 bg-white/10 px-3 py-1.5 md:px-5 md:py-2.5 rounded-full backdrop-blur-md border border-white/10 hover:bg-white/20 transition-colors">
										<MapPin
											...
											className="md:w-[18px] md:h-[18px] text-[#46b94e]"
										/>
										<span className="font-sf-pro truncate max-w-[150px] md:max-w-none">
											{venue}
										</span>
									</div>
								</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-12">
						...
						>
							<div className="bg-white/5 border border-white/10 rounded-[20px] md:rounded-[25px] p-5 md:p-8 backdrop-blur-md relative overflow-hidden group hover:border-[#46b94e]/30 transition-colors duration-500">
								<h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 text-[#46b94e] font-sf-pro">
									About Event
								</h2>
						...
						>
							...
							{(() => {
								...
								const isActuallyOpen =
									isRegOpen === true || isRegOpen === undefined;
								...
								if (isActuallyOpen) {
									return (
										<div className="bg-gradient-to-br from-[#46b94e]/10 to-emerald-900/10 border border-[#46b94e]/30 rounded-[20px] md:rounded-[25px] p-5 md:p-8 backdrop-blur-md relative overflow-hidden group">
											...
											<h3 className="text-xl md:text-2xl font-bold mb-2 font-sf-pro relative z-10">
												Registration Open!
											</h3>
											<p className="text-gray-400 mb-5 md:mb-8 text-xs md:text-sm font-sf-pro relative z-10">
												Secure your spot for this event now. Limited seats
												available.
											</p>
											<Link
												...
												rel={
													hasExternalLink ? "noopener noreferrer" : undefined
												}
									...
									return (
										<div className="bg-gradient-to-br from-red-500/10 to-rose-900/10 border border-red-500/30 rounded-[20px] md:rounded-[25px] p-5 md:p-8 backdrop-blur-md relative overflow-hidden group">
											<h3 className="text-xl md:text-2xl font-bold mb-2 font-sf-pro relative z-10 text-red-400">
							...
							{galleryImages && galleryImages.length > 0 && (
								<div className="bg-white/5 border border-white/10 rounded-[20px] md:rounded-[25px] p-5 md:p-8 backdrop-blur-md hover:bg-white/10 transition-colors duration-300">
									<h3 className="text-lg md:text-xl font-bold mb-2 font-sf-pro">
										Event Gallery
									</h3>
									<p className="text-gray-400 mb-4 md:mb-6 text-xs md:text-sm font-sf-pro">
