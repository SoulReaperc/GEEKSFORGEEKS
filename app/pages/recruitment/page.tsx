...
async function getRecruitmentStatus() {
	try {
		...
		if (entries.items.length > 0) {
			return (entries.items[0] as { fields: Record<string, unknown> }).fields.isRecruitmentOpen || false;
		}
		return false;
	} catch (error) {
		...
		<div className="min-h-screen flex items-center justify-center bg-black relative">
			...
			<div className="relative z-10 max-w-lg mx-auto p-8 bg-black/60 border border-white/10 rounded-3xl backdrop-blur-xl text-center">
				...
				<p className="text-gray-400 mb-8">
					Thank you for your interest in joining GeeksForGeeks SRMIST! Our
					recruitment process is currently not accepting new applications.
