...
export default async function Home() {
	const socialLogos = [
		...
		{
			node: <SiLinkedin color="#ffffff" />,
			title: "LinkedIn",
			href: "https://www.linkedin.com/company/gfgsrmist/",
		},
		{
			node: <SiDiscord color="#ffffff" />,
			title: "Discord",
			href: "https://discord.gg/58uwPkFjJJ",
		},
		{
			node: <SiX color="#ffffff" />,
			title: "Instagram",
			href: "https://x.com/gfg_srmist_ncr?s=11",
		},
		{
			node: <SiInstagram color="#ffffff" />,
			title: "Instagram",
