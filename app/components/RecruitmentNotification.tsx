...
export default function RecruitmentNotification({
	isRecruitmentOpen,
}: {
		...
		<AnimatePresence mode="wait">
				...
				>
					...
					>
						...
						<p className="text-white/60 text-sm mb-8 leading-relaxed max-w-[90%]">
							Join our team and be part of something great. We are looking for
							talented individuals to join our campus body.
						</p>
						<Link
			...
			{(stage === "collapsed" || stage === "expanded") && (
				...
				>
						...
						{stage === "expanded" && (
							...
							>
								...
								<p className="text-white/60 text-sm mb-5 leading-relaxed">
									Recruitment forms are officially open. Join our team and be
					...
					<button
						onClick={() =>
							setStage(stage === "expanded" ? "collapsed" : "expanded")
						}
