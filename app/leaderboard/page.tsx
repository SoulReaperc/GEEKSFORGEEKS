...
async function getFullLeaderboard() {
	try {
		...
		const { data, error } = await supabase
			.from("profiles")
			.select(
				"id, username, full_name, avatar_url, total_points, rank, college_email",
			)
			.order("total_points", { ascending: false })
...
export const metadata = {
	...
	description:
		"Compete with the best coders and climb the ranks in the GFG SRMIST coding platform",
	openGraph: {
		title: "Global Leaderboard | GFG SRMIST",
