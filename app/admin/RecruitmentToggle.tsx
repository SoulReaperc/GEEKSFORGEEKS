		...
		<div className="backdrop-blur-md bg-gradient-to-r from-white/10 to-white/5 border border-white/20 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
			<div className="flex-1 text-center md:text-left">
				<div className="flex items-center gap-3 justify-center md:justify-start mb-2">
					<div
						className={`w-3 h-3 rounded-full ${isRecruitmentOpen ? "bg-green-400 shadow-[0_0_10px_rgba(74,222,128,0.8)]" : "bg-red-400 shadow-[0_0_10px_rgba(248,113,113,0.8)]"} animate-pulse`}
					/>
					<p
						className={`text-2xl font-bold ${isRecruitmentOpen ? "text-green-400" : "text-red-400"}`}
					>
			...
			<button
				...
				title={
					isRecruitmentOpen
						? "Click to close recruitment"
						: "Click to open recruitment"
				}
			>
				<span
