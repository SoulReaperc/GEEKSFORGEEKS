...
import { AlertTriangle, Eye, EyeOff, Save, Trash2, X } from "lucide-react";
			...
			{isOpen && (
				...
				>
					...
					<div className="flex flex-col items-center text-center w-full px-2">
						<div
							className={`w-12 h-12 mb-3 rounded-full flex items-center justify-center ${isDestructive ? "bg-red-500/20 text-red-500" : "bg-yellow-500/20 text-yellow-500"}`}
						>
							{isDestructive ? (
								<Trash2 size={24} />
						...
						<div className="flex w-full gap-2">
							...
							<button
								...
								className={`flex-1 px-3 py-2.5 text-sm font-medium text-white rounded-xl transition-colors ${
									isDestructive
