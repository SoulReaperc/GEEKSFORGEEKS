	...
	return (
		<div className="min-h-screen bg-black text-white relative overflow-hidden">
			...
			<div className="fixed inset-0 z-0">
				...
				<div
					className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-emerald-600/20 rounded-full blur-[128px] animate-pulse"
						...
						<div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
							<div className="flex flex-col items-center">
								<div className="relative group mb-3">
									<div className="w-36 h-36 rounded-full overflow-hidden border-4 border-green-500/50 shadow-2xl shadow-green-500/20 transition-all group-hover:border-green-400 group-hover:shadow-green-400/30">
										<img
											src={
												profile.avatar_url ||
												`https://ui-avatars.com/api/?name=${profile.full_name || "User"}&background=2f8d46&color=fff&size=200`
											}
											alt="Avatar"
								...
								<h2 className="text-2xl font-bold mb-1 text-center">
									{profile.full_name || "Anonymous Coder"}
								</h2>
								<p className="text-sm text-white/50 mb-4 text-center break-all">
						...
						<div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 md:p-10 shadow-2xl h-full flex flex-col">
							...
							>
								<div className="flex-1 space-y-6">
									...
									{message.text && (
										<div
											className={`p-4 rounded-xl text-sm font-medium flex items-center gap-3 animate-in slide-in-from-top-2 ${message.type === "error" ? "bg-red-500/20 text-red-300 border border-red-500/30" : "bg-green-500/20 text-green-300 border border-green-500/30"}`}
										>
											{message.type === "error" ? (
												<svg
